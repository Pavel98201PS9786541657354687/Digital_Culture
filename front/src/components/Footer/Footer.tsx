    ...
    <footer className="footer">
      ...
      <div className="footer-content">
        <div className="footer-content-logo" onClick={() => navigate("/")}>
          <img
            className="footer-content-logo__eye"
            src={liveLogoEyeGif}
            alt=""
          />
          <img
            className="footer-content-logo__letters"
            src={liveLogoLettersGif}
            alt=""
          />
        </div>
        ...
        <div className="footer-content-language" onClick={handleSwitchLanguage}>
          RU / ENG
        </div>
        <div className="footer-content-copyright">
          © {literalContent.copyright[language]}
        </div>
        <a className="footer-content-policy" href="">
          {literalContent.privacyPolicy[language]}
        </a>
      </div>
    </footer>
  );
